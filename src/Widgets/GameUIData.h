...
enum SpriteIdMapPanels : unsigned int
{
    ...
    IND_MINIMAP_BTN_T_NORMAL,
    IND_MINIMAP_BTN_T_DISABLED,
    IND_MINIMAP_BTN_T_OVER,
    IND_MINIMAP_BTN_T_PUSHED,
    IND_MINIMAP_BTN_B_NORMAL,
    IND_MINIMAP_BTN_B_DISABLED,
    IND_MINIMAP_BTN_B_OVER,
    IND_MINIMAP_BTN_B_PUSHED,
